...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="SYSTM002" description="App which provides software &#xA;timer in micro seconds &#xA;scale interface for all &#xA;non rtos applications." descriptionURL="/doc/html/group___s_y_s_t_m002_app.html" mode="SHARABLE" URI="http://www.infineon.com/1.0.12/app/systm002/0">
  <provided xsi:type="ResourceModel:IntegerParameter" name="SysTick Interval" evalFunction="&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;function ForwardMapping()&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;{&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  &#xD;&#xA;                  var Res1 = 0;&#xD;&#xA;  &#x9;  &#x9;&#x9;&#x9;  var XMC1xxx=SCM.getSoftwareId().substring(0,1).compareTo(&quot;1&quot;);  &#xD;&#xA;&#x9;   &#x9;&#x9;&#x9;  if(XMC1xxx==0)&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;  Res1 = SCM.getResource(&quot;clockapp/clk002_irMCLK&quot;);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  else&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;   {                  &#xD;&#xA;&#x9;                  Res1 = SCM.getResource(&quot;clkapp/clk001_iroActualFreqSystem&quot;);          &#xD;&#xA;&#x9;&#x9;&#x9;&#x9;   }&#xD;&#xA;&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  var clock = SCM.getDoubleValue(Res1);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  var Res = SCM.getResource(&quot;syst/rvr&quot;);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  var Value = SCM.getIntValue(Res); &#x9;&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  var sysinterval = SCM.getIntValue(currentResource);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  var value = ((clock * sysinterval) - 1);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  SCM.setIntValue(Res,value);&#x9;&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  var tempRes = SCM.getResource(&quot;systm002_Dummy&quot;);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  SCM.setIntValue(tempRes,sysinterval);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;}&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;function BackwardMapping()&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;{&#xD;&#xA;&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;   var Res1 = 0;&#xD;&#xA;  &#x9;  &#x9;&#x9;&#x9;  var XMC1xxx=SCM.getSoftwareId().substring(0,1).compareTo(&quot;1&quot;);  &#xD;&#xA;&#x9;   &#x9;&#x9;&#x9;  if(XMC1xxx==0)&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;  Res1 = SCM.getResource(&quot;clockapp/clk002_irMCLK&quot;);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  else&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;   {                  &#xD;&#xA;&#x9;                  Res1 = SCM.getResource(&quot;clkapp/clk001_iroActualFreqSystem&quot;);          &#xD;&#xA;&#x9;&#x9;&#x9;&#x9;   }&#xD;&#xA;                   var clock = SCM.getDoubleValue(Res1);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  var tempRes = SCM.getResource(&quot;systm002_Dummy&quot;);&#xD;&#xA;                  var value = SCM.getIntValue(tempRes);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  SCM.setIntValue(currentResource,value);&#x9;&#x9;&#xD;&#xA;&#xD;&#xA;                //Modify Min MAX value according the configured clock&#xD;&#xA;                // SYSTICK  max value will be 24 bit&#xD;&#xA;                   var Res22 = (16777215/clock);&#xD;&#xA;                    var res_max=Math.ceil(Res22);&#xD;&#xA;&#x9;&#x9;&#x9;       var res_min=Math.ceil(1);&#xD;&#xA;&#x9;&#x9;&#x9;     SCM.setMinMaxValue(currentResource,res_min,res_max,1);&#xD;&#xA;&#x9;&#x9;&#x9;  &#xD;&#xA;&#x9;&#x9;&#x9;&#x9;}&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;" URI="http://www.infineon.com/1.0.12/app/systm002/0/systm002_systickinterval" downWardmappedList="//@consumed.6 //@consumed.0" maxValue="22223" minValue="1">
    <defaultValue xsi:type="ResourceModel:IntegerValue" value="186a0"/>
    <localValue xsi:type="ResourceModel:StringValue" value="64"/>
    <globalValue xsi:type="ResourceModel:IntegerValue" value="64"/>
    <toolTipHelpDescription>This defines the resolution of the SysTick timer in ticks per microsecs.</toolTipHelpDescription>
  </provided>
  <provided xsi:type="ResourceModel:IntegerParameter" name="Number of Software timers" evalFunction="&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;function ForwardMapping()&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;{&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  var Intvalue = SCM.getIntValue(currentResource);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  SCM.setIntValue(currentResource,Intvalue);&#x9;&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;}&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;function BackwardMapping()&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;{&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  var Intvalue = SCM.getIntValue(currentResource);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;  SCM.setIntValue(currentResource,Intvalue);&#x9;&#x9;&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;}&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;" URI="http://www.infineon.com/1.0.12/app/systm002/0/systm002_swtimers" maxValue="20" minValue="1">
  ...
  <provided xsi:type="ResourceModel:IntegerParameter" name="Preemption Priority for Timm" evalFunction="&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;function ForwardMapping()&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;{&#xD;&#xA;&#xD;&#xA;&#x9;&#x9;  &#x9;  &#x9;&#x9;&#x9;  var XMC1xxx=SCM.getSoftwareId().substring(0,1).compareTo(&quot;1&quot;);  &#xD;&#xA;&#x9;   &#x9;&#x9;&#x9;&#x9;&#x9;  if(XMC1xxx==0)&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;{&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#xD;&#xA;&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;var Res = SCM.getResource(&quot;syst/shpr3_pri_15&quot;); &#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;var Intvalue = SCM.getIntValue(Res); &#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;var BitShift = 2; &#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;var BitMask = 0x03; &#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;var Intvalue1 = SCM.getIntValue(currentResource);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;Intvalue = (Intvalue &amp; BitMask) | (Intvalue1 &lt;&lt; BitShift);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;SCM.setIntValue(Res,Intvalue);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;}&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;}&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;function BackwardMapping()&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;{&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;var Res = SCM.getResource(&quot;syst/shpr3_pri_15&quot;); &#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;var Intvalue = SCM.getIntValue(Res); &#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;var BitShift = 2; &#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;var BitMask = 0xFC; &#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;SCM.setIntValue(currentResource,(Intvalue &amp; BitMask)>>BitShift);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;&#x9;}&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;" URI="http://www.infineon.com/1.0.12/app/systm002/0/systm002_irwinterruptprio_timm" maxValue="3" minValue="0">
...
0-3 is least priority equivalent to 192 </toolTipHelpDescription>
  ...
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.12/app/systm002/0/systm002_dummy" upWardMappingList="//@provided.0" isSystemDefined="true">
    <localValue xsi:type="ResourceModel:IntegerValue" value="64"/>
    <globalValue xsi:type="ResourceModel:IntegerValue" value="64"/>
    <requiredResource uriString="" uriType="LOCALTYPE"/>
  </consumed>
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.12/app/systm002/0/syst">
  ...
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.12/app/systm002/0/systm002_dummyswtimers" isSystemDefined="true">
    <requiredResource uriString="" uriType="LOCALTYPE"/>
  </consumed>
  <consumed xsi:type="ResourceModel:ProxyResource" evalFunction="function resourceCondition() {&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;var value1 = Solver.getSoftwareId().substring(0,1).compareTo(&quot;1&quot;);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;if((value1  == 0 )) {&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;  return false;&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;}&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;return true;&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;}" URI="http://www.infineon.com/1.0.12/app/systm002/0/clkapp">
  ...
  <consumed xsi:type="ResourceModel:ProxyResource" evalFunction="function resourceCondition() {&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;var value1 = Solver.getSoftwareId().substring(0,1).compareTo(&quot;1&quot;);&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;if((value1  == 0 )) {&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;  return true;&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;}&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;&#x9;return false;&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;}" URI="http://www.infineon.com/1.0.12/app/systm002/0/clockapp">
    <requiredResource uriString="app/clk002/*" uriType="LOCALTYPE"/>
  </consumed>
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.12/app/systm002/0/syst/csr" isSystemDefined="true">
  ...
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.12/app/systm002/0/syst/rvr" upWardMappingList="//@provided.0" isSystemDefined="true">
    <localValue xsi:type="ResourceModel:IntegerValue" value="2edf"/>
    <downWardmappedList xsi:type="ResourceModel:RegisterParameter" href="../../CPU/CPU_0.dd#//@provided.5"/>
    <globalValue xsi:type="ResourceModel:IntegerValue" value="2edf"/>
  </consumed>
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.12/app/systm002/0/syst/cvr" isSystemDefined="true">
    <localValue xsi:type="ResourceModel:IntegerValue" value="0"/>
    <downWardmappedList xsi:type="ResourceModel:RegisterParameter" href="../../CPU/CPU_0.dd#//@provided.6"/>
    <globalValue xsi:type="ResourceModel:IntegerValue" value="0"/>
  </consumed>
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.12/app/systm002/0/syst/calib" isSystemDefined="true">
    <localValue xsi:type="ResourceModel:IntegerValue" value="0"/>
    <downWardmappedList xsi:type="ResourceModel:RegisterParameter" href="../../CPU/CPU_0.dd#//@provided.7"/>
    <globalValue xsi:type="ResourceModel:IntegerValue" value="0"/>
  </consumed>
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.12/app/systm002/0/syst/shpr3_pri_15" upWardMappingList="//@provided.2 //@provided.4" isSystemDefined="true">
    <localValue xsi:type="ResourceModel:IntegerValue" value="28"/>
    <globalValue xsi:type="ResourceModel:IntegerValue" value="28"/>
  </consumed>
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.12/app/systm002/0/clkapp/clk001_iroactualfreqsystem" upWardMappingList="//@provided.0" isSystemDefined="true">
  ...
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.12/app/systm002/0/clockapp/clk002_irmclk" isSystemDefined="true"/>
  ...
  <datagenerate fileName="SYSTM002.c" templateFileName="SYSTM002.cdt" templateEngine="NONE" fileAction="COPY"/>
  <datagenerate fileName="SYSTM002.h" fileType="HFILE" templateFileName="SYSTM002.hdt" templateEngine="NONE" fileAction="COPY"/>
  <datagenerate fileName="SYSTM002_Conf.h" fileType="HFILE" templateFileName="SYSTM002_Confh.jet"/>
