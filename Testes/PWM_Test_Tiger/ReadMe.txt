DESCRIPTION:
 ...
 The on-board LED (Port 1.1) will be dim due to duty cycle of 10%.
 The on-board LED (Port 1.1) will be bright due to duty cycle of 90%.
...
- XMC4500 Relax Lite Kit-V1 or XMC4500 Relax Kit-V1

SETUP:Connect the USB cable with XMC4500 Relax Kit-V1.

HOW TO CREATE THE PROJECT:
1) Instantiate PWMSP001 App and NVIC002 App from App Selection View
2) In PWMSP001, Select Edge-Aligned Mode, enter the PWM freq as 1500 Hz, Select Period Match Initialization in 
...
5) Manual Pin assignment: This is to define the board specific I/O constraints
	 In this case, PWMSP001/0 pin_directoutput resource is assigned to port P1.1 as a LED indicator.
...
OBSERVATIONS:
1. LED1 at P1.1 brightness increases and decreases.
